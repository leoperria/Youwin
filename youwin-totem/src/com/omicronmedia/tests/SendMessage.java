...
package com.omicronmedia.tests;
...
public class SendMessage
{
	public void doIt() throws Exception
	{
		...
		srv = new Service();
		SerialModemGateway gateway = new SerialModemGateway("modem.com3", "COM3", 115200, "Siemens", "MC35i");
		...
		msg = new OutboundMessage("+393284347808", "Hello from SMSLib!");
		srv.sendMessage(msg);
